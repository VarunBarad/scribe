1. Ensure the Raspberry Pi is running and then go to http://scribe.local:631 (you can replace the scribe.local domain with the actual IP address)
...
6. Use "http://scribe.local:631" as the connection URI
